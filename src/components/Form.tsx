...
export const Form = () => {
    return (
        <div className="gap-4 bg-Navy-850 p-6 rounded-lg text-center absolute top-[-175px] left-[0rem] right-[0rem] mx-4 shadow-lg shadow-Cyan-500/50 w-[336px] md:w-[480px] mx-auto">
